...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void jTextField_UNActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO 
    }
    ...
    private void jTextField_FNActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO 
    }

    private void jTextField_LNActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO 
    }

    private void jPasswordField_REPASSActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO 
    }
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {
          ...
          String query="Insert into usersInfo(u_fname, u_lname, u_uname, u_pass) values(?,?,?,?)";
        try {
    ...
    public boolean checkUsername(String username){
        ...
        boolean checkUser = false;
         ...
         String query = "SELECT * FROM usersInfo where u_uname=?";
        try {
            ps= MyConnection.getConnection().prepareStatement(query);
